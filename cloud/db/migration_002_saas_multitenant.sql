-- ============================================================================
-- Migration 002: Multi-tenant SaaS (farms, user columns, audit_log)
-- Run against existing DBs that were created before init.sql included SaaS tables.
-- Greenfield: use cloud/db/init.sql only.
-- ============================================================================
